...
OceanViewManager.prototype.insertLocationNavElement = function( index, elementId ) {
  ...
  var locationHTML = '<div id="locBut' + index + '" class="liItem liItemBorderBlue" onclick="audioPlayerClicked(' + index + ')" style="background: #666 url( \'images/locations/' + thumbImageURL + '\' ) no-repeat center center;background-size: cover;"><image id="locAudioBut' + index + '" class="buttonImage playButtonImage" width="75" height="75" border="0" alt=""></image><span>' + locationName + '</span></div>';
