...
- Complete the PRESS-RELEASE.md template (<30min)
  - [v] Pick an idea (implement a technology, build a product, make art, etc).
  - [v] Write it down on paper
  - [v] Imagine what portion of this could be done in 24 hours.
  - [v] Cut the scope in half.
  - [v] Cut the above scope in half again.
  - [v] Fill in the README.md template document
